...
(cl:defmethod target_type-val ((m <GrabHDRImageGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader camera_control_msgs-msg:target_type-val is deprecated.  Use camera_control_msgs-msg:target_type instead.")
  (target_type m))

(cl:ensure-generic-function 'target_values-val :lambda-list '(m))
(cl:defmethod target_values-val ((m <GrabHDRImageGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader camera_control_msgs-msg:target_values-val is deprecated.  Use camera_control_msgs-msg:target_values instead.")
  (target_values m))
...
(cl:defmethod gamma_values-val ((m <GrabHDRImageGoal>))
  ...
  (gamma_values m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<GrabHDRImageGoal>)))
    "Constants for message type '<GrabHDRImageGoal>"
  '((:BRIGHTNESS . 1)
    (:EXPOSURE . 2))
)
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql 'GrabHDRImageGoal)))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GrabHDRImageGoal>)))
  ...
  "bebd46d3bb820458935c996dfc0a7b94")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GrabHDRImageGoal)))
  "Returns md5sum for a message object of type 'GrabHDRImageGoal"
  "bebd46d3bb820458935c996dfc0a7b94")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <GrabHDRImageGoal>))
  (cl:+ 0
     1
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'target_values) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
     1
