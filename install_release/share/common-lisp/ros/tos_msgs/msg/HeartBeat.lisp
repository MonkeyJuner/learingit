...
(cl:defmethod cl:initialize-instance :after ((m <HeartBeat>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HeartBeat)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tos_msgs-msg:<HeartBeat> is deprecated: use tos_msgs-msg:HeartBeat instead.")))
...
(cl:defmethod chid-val ((m <HeartBeat>))
...
(cl:defmethod send_packet_id-val ((m <HeartBeat>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<HeartBeat>)))
  ...
  "8d8c1d205c3a88ab24b1e24bfe8dd4e2")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'HeartBeat)))
  "Returns md5sum for a message object of type 'HeartBeat"
  "8d8c1d205c3a88ab24b1e24bfe8dd4e2")
