...
;//! \htmlinclude ADSCmdCalibrate.msg.html

(cl:defclass <ADSCmdCalibrate> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass ADSCmdCalibrate (<ADSCmdCalibrate>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <ADSCmdCalibrate>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'ADSCmdCalibrate)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ads_msgs-msg:<ADSCmdCalibrate> is deprecated: use ads_msgs-msg:ADSCmdCalibrate instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ADSCmdCalibrate>))
...
(cl:defmethod id-val ((m <ADSCmdCalibrate>))
...
(cl:defmethod count-val ((m <ADSCmdCalibrate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ads_msgs-msg:count-val is deprecated.  Use ads_msgs-msg:count instead.")
  (count m))

(cl:ensure-generic-function 'longitude_dist-val :lambda-list '(m))
(cl:defmethod longitude_dist-val ((m <ADSCmdCalibrate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ads_msgs-msg:longitude_dist-val is deprecated.  Use ads_msgs-msg:longitude_dist instead.")
  (longitude_dist m))

(cl:ensure-generic-function 'lateral_dist-val :lambda-list '(m))
(cl:defmethod lateral_dist-val ((m <ADSCmdCalibrate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ads_msgs-msg:lateral_dist-val is deprecated.  Use ads_msgs-msg:lateral_dist instead.")
  (lateral_dist m))

(cl:ensure-generic-function 'longitude_thr-val :lambda-list '(m))
(cl:defmethod longitude_thr-val ((m <ADSCmdCalibrate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ads_msgs-msg:longitude_thr-val is deprecated.  Use ads_msgs-msg:longitude_thr instead.")
  (longitude_thr m))

(cl:ensure-generic-function 'lateral_thr-val :lambda-list '(m))
(cl:defmethod lateral_thr-val ((m <ADSCmdCalibrate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ads_msgs-msg:lateral_thr-val is deprecated.  Use ads_msgs-msg:lateral_thr instead.")
  (lateral_thr m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ADSCmdCalibrate>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ADSCmdCalibrate>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ADSCmdCalibrate>)))
  "Returns string type for a message object of type '<ADSCmdCalibrate>"
  "ads_msgs/ADSCmdCalibrate")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ADSCmdCalibrate)))
  "Returns string type for a message object of type 'ADSCmdCalibrate"
  "ads_msgs/ADSCmdCalibrate")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ADSCmdCalibrate>)))
  "Returns md5sum for a message object of type '<ADSCmdCalibrate>"
  "ae168eb424739dfee5633c98c176c140")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ADSCmdCalibrate)))
  "Returns md5sum for a message object of type 'ADSCmdCalibrate"
  "ae168eb424739dfee5633c98c176c140")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ADSCmdCalibrate>)))
  "Returns full string definition for message of type '<ADSCmdCalibrate>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ADSCmdCalibrate)))
  "Returns full string definition for message of type 'ADSCmdCalibrate"
  (cl:format cl:nil "Header header~%~%uint32 id~%~%uint32 count~%~%# measure by m, longitudinal distance from target position~%float64 longitude_dist~%~%# meausre by m, lateral distance from target position~%float64 lateral_dist~%~%float64 longitude_thr~%~%float64 lateral_thr~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ADSCmdCalibrate>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ADSCmdCalibrate>))
  "Converts a ROS message object to a list"
  (cl:list 'ADSCmdCalibrate
