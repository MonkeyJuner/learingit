...
class ADSCmdAlert {
  ...
  static datatype() {
    ...
    return 'ads_msgs/ADSCmdAlert';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'f598337d84289df261d60f9a2aa46008';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ADSCmdAlert(null);
...
ADSCmdAlert.Constants = {
  NONE: 0,
  ALIGNING: 1,
}

module.exports = ADSCmdAlert;
