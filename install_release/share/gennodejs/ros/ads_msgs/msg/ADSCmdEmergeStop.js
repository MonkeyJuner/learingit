...
class ADSCmdEmergeStop {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ADSCmdEmergeStop(null);
  ...
  static datatype() {
    ...
    return 'ads_msgs/ADSCmdEmergeStop';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ADSCmdEmergeStop(null);
...
module.exports = ADSCmdEmergeStop;
