...
class ADSCmdGuideStop {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ADSCmdGuideStop(null);
  ...
  static datatype() {
    ...
    return 'ads_msgs/ADSCmdGuideStop';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'ca77bea5ffd1ee11552bf17cb7a684f7';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ADSCmdGuideStop(null);
...
module.exports = ADSCmdGuideStop;
