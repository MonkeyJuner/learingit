...
"""autogenerated by genpy from visual_msgs/VirtualWalls.msg. Do not edit."""
import sys
...
class VirtualWalls(genpy.Message):
  _md5sum = "eeccf1d1abd9782305d24f6691c59a03"
  _type = "visual_msgs/VirtualWalls"
...
"""
  ...
  _slot_types = ['std_msgs/Header','visual_msgs/VirtualWall[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(VirtualWalls, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = visual_msgs.msg.VirtualWall()
        _x = val1
        start = end
        end += 53
