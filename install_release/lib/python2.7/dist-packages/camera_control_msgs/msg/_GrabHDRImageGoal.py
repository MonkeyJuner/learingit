...
class GrabHDRImageGoal(genpy.Message):
  _md5sum = "bebd46d3bb820458935c996dfc0a7b94"
...
"""
  ...
  __slots__ = ['target_type','target_values','exposure_given','exposure_times','exposure_fixed','brightness_given','brightness_values','brightness_continuous','gain_given','gain_values','gain_fixed','gamma_given','gamma_values']
  _slot_types = ['uint8','float32[]','bool','float32[]','bool','bool','float32[]','bool','bool','float32[]','bool','bool','float32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       target_type,target_values,exposure_given,exposure_times,exposure_fixed,brightness_given,brightness_values,brightness_continuous,gain_given,gain_values,gain_fixed,gamma_given,gamma_values
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.target_values))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.target_values = struct.unpack(pattern, str[start:end])
      start = end
      end += 1
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.target_values = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      start = end
      end += 1
      (self.exposure_given,) = _get_struct_B().unpack(str[start:end])
      self.exposure_given = bool(self.exposure_given)
