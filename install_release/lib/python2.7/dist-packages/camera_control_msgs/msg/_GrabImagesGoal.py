...
class GrabImagesGoal(genpy.Message):
  _md5sum = "3d54c9d7a8dc9ac9b2780e7fc29ec951"
...
"""
  ...
  __slots__ = ['target_type','target_values','exposure_given','exposure_times','gain_given','gain_values','gamma_given','gamma_values','brightness_given','brightness_values','exposure_auto','gain_auto']
  _slot_types = ['uint8','float32[]','bool','float32[]','bool','float32[]','bool','float32[]','bool','float32[]','bool','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       target_type,target_values,exposure_given,exposure_times,gain_given,gain_values,gamma_given,gamma_values,brightness_given,brightness_values,exposure_auto,gain_auto
